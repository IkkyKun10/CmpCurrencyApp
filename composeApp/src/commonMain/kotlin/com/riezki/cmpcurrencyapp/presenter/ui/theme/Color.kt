...
val testColor = @Composable { if (isSystemInDarkTheme()) Color(0xFF000000) else Color(0xFFFFFFFF) }
val testColor2 = @Composable { if (isSystemInDarkTheme()) Color(0xFF000000) else Color(0xFFFFFFFF) }